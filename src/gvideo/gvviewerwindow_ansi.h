...
// ===
///
/// \file gvviewerwindow_ansi.h
///

#ifndef GV_VIEWERWINDOW_ANSI__H
#define GV_VIEWERWINDOW_ANSI__H
...
/// \class Gv::ViewerWindowAnsi
/// A pimple-pattern implementation class for Gv::ViewerWindow that uses ansi 
/// escape sequences.
/// 
class Gv::ViewerWindowAnsi : public ViewerWindow
{
public:
...
private:
	ViewerWindowAnsi( const ViewerWindowAnsi & ) ;
	void operator=( const ViewerWindowAnsi & ) ;
