...
#define G_DEF__H
	 ...
	 */
	#if defined(_WIN32) && !defined(G_WIN32)
		#define G_WIN32 1
	#endif
	#if !defined(_WIN32) && !defined(G_UNIX)
		#define G_UNIX 1
	#endif
	 ...
	 */
		...
		#define GCONFIG_HAVE_CXX_NULLPTR defined(G_COMPILER_CXX_11)
	#endif
	#if !defined(GCONFIG_HAVE_CXX_CONSTEXPR)
		#define GCONFIG_HAVE_CXX_CONSTEXPR defined(G_COMPILER_CXX_11)
	#endif
	#if !defined(GCONFIG_HAVE_CXX_NOEXCEPT)
		#define GCONFIG_HAVE_CXX_NOEXCEPT defined(G_COMPILER_CXX_11)
	#endif
	#if !defined(GCONFIG_HAVE_CXX_OVERRIDE)
		#define GCONFIG_HAVE_CXX_OVERRIDE (defined(G_COMPILER_CXX_11) || _MSC_VER >= 1800)
	#endif
	#if !defined(GCONFIG_HAVE_CXX_FINAL)
		#define GCONFIG_HAVE_CXX_FINAL (defined(G_COMPILER_CXX_11) || _MSC_VER >= 1800)
	#endif
	#if !defined(GCONFIG_HAVE_CXX_SHARED_PTR)
		#define GCONFIG_HAVE_CXX_SHARED_PTR (defined(G_COMPILER_CXX_11) || _MSC_VER >= 1800)
	#endif
	#if !defined(GCONFIG_HAVE_CXX_STD_THREAD)
		#define GCONFIG_HAVE_CXX_STD_THREAD (defined(G_COMPILER_CXX_11) || _MSC_VER >= 1800)
	#endif
	#if !defined(GCONFIG_HAVE_CXX_TYPE_TRAITS_MAKE_UNSIGNED)
		#define GCONFIG_HAVE_CXX_TYPE_TRAITS_MAKE_UNSIGNED (defined(G_COMPILER_CXX_11) || _MSC_VER >= 1800)
	#endif
	#if !defined(GCONFIG_HAVE_CXX_EMPLACE)
		#define GCONFIG_HAVE_CXX_EMPLACE (defined(G_COMPILER_CXX_11) || _MSC_VER >= 1800)
	#endif
	#if !defined(GCONFIG_HAVE_DIRENT_H)
		#define GCONFIG_HAVE_DIRENT_H 1
	#endif
	#if !defined(GCONFIG_HAVE_READLINK)
		#define GCONFIG_HAVE_READLINK defined(G_UNIX)
	#endif
	#if !defined(GCONFIG_HAVE_ERRNO_T)
		#define GCONFIG_HAVE_ERRNO_T defined(G_WIN32)
	#endif
	#if !defined(GCONFIG_HAVE_GETENV_S)
		#define GCONFIG_HAVE_GETENV_S ( defined(G_WIN32) || defined(getenv_s) )
	#endif
		...
		#define GCONFIG_HAVE_GMTIME_S ( defined(G_WIN32) || defined(gmtime_s) )
	#endif
		...
		#define GCONFIG_HAVE_LOCALTIME_S ( defined(G_WIN32) || defined(localtime_s) )
	#endif
		...
		#define GCONFIG_HAVE_SETGROUPS defined(G_UNIX)
	#endif
		...
		#define GCONFIG_HAVE_STRNCPY_S ( defined(G_WIN32) || defined(strncpy_s) )
	#endif
		...
		#define GCONFIG_HAVE_MISSING_STD_ABORT defined(G_WINDOWS)
	#endif
	#if !defined(GCONFIG_HAVE_MISSING_STD_EXIT)
		#define GCONFIG_HAVE_MISSING_STD_EXIT defined(G_WINDOWS)
	#endif
	#if !defined(GCONFIG_HAVE_MISSING_STD_SYSTEM)
		#define GCONFIG_HAVE_MISSING_STD_SYSTEM defined(G_WINDOWS)
	#endif
	#if !defined(GCONFIG_HAVE_MISSING_STD_MEMSET)
		#define GCONFIG_HAVE_MISSING_STD_MEMSET defined(G_WINDOWS)
	#endif
	#if !defined(GCONFIG_HAVE_MISSING_STD_MEMCPY)
		#define GCONFIG_HAVE_MISSING_STD_MEMCPY defined(G_WINDOWS)
	#endif
	#if !defined(GCONFIG_HAVE_MISSING_STD_STRERROR)
		#define GCONFIG_HAVE_MISSING_STD_STRERROR defined(G_WINDOWS)
	#endif
	#if !defined(GCONFIG_HAVE_MISSING_STD_FOPEN)
		#define GCONFIG_HAVE_MISSING_STD_FOPEN defined(G_WINDOWS)
	#endif
	#if !defined(GCONFIG_HAVE_MISSING_STD_FCLOSE)
		#define GCONFIG_HAVE_MISSING_STD_FCLOSE defined(G_WINDOWS)
	#endif
	#if !defined(GCONFIG_HAVE_MISSING_STD_FPUTS)
		#define GCONFIG_HAVE_MISSING_STD_FPUTS defined(G_WINDOWS)
	#endif
	#if !defined(GCONFIG_HAVE_UID_T)
		#define GCONFIG_HAVE_UID_T defined(G_UNIX)
	#endif
	#if !defined(GCONFIG_HAVE_GID_T)
		#define GCONFIG_HAVE_GID_T GCONFIG_HAVE_UID_T
	#endif
	#if !defined(GCONFIG_HAVE_SSIZE_T)
		#define GCONFIG_HAVE_SSIZE_T ( defined(G_UNIX) || defined(G_MINGW) )
	#endif
	#if !defined(GCONFIG_HAVE_PID_T)
		#define GCONFIG_HAVE_PID_T ( defined(G_UNIX) || defined(G_MINGW) )
	#endif
	#if !defined(GCONFIG_HAVE_GET_WINDOW_LONG_PTR)
		#define GCONFIG_HAVE_GET_WINDOW_LONG_PTR defined(G_WIN32)
	#endif
	#if !defined(GCONFIG_HAVE_MREMAP)
		#define GCONFIG_HAVE_MREMAP defined(G_UNIX_LINUX)
	#endif
	#if !defined(GCONFIG_HAVE_TIMERFD)
		#define GCONFIG_HAVE_TIMERFD defined(G_UNIX_LINUX)
	#endif
	#if !defined(GCONFIG_HAVE_PAM)
		#define GCONFIG_HAVE_PAM defined(G_UNIX)
	#endif
	#if !defined(GCONFIG_HAVE_PAM_IN_SECURITY)
		#define GCONFIG_HAVE_PAM_IN_SECURITY defined(G_UNIX)
	#endif
		...
		#define GCONFIG_HAVE_GET_NATIVE_SYSTEM_INFO defined(G_WIN32)
	#endif
		...
		#define GCONFIG_HAVE_V4L defined(G_UNIX_LINUX)
	#endif
		...
		#define GCONFIG_HAVE_SEM_INIT ( defined(G_UNIX_LINUX) || defined(G_UNIX_FREEBSD) )
	#endif
	#if !defined(GCONFIG_HAVE_X11)
		#define GCONFIG_HAVE_X11 defined(G_UNIX)
	#endif
	#if !defined(GCONFIG_HAVE_OPENSSL)
		#define GCONFIG_HAVE_OPENSSL defined(G_UNIX)
	#endif
		...
		#define GCONFIG_HAVE_BOOST defined(G_UNIX_LINUX)
	#endif
	#if !defined(GCONFIG_HAVE_ALSA)
		#define GCONFIG_HAVE_ALSA defined(G_UNIX_LINUX)
	#endif
	#if !defined(GCONFIG_HAVE_FMEMOPEN)
		#define GCONFIG_HAVE_FMEMOPEN !defined(G_UNIX_OPENBSD)
	#endif
	#if !defined(GCONFIG_HAVE_X11)
		#define GCONFIG_HAVE_X11 defined(G_UNIX)
	#endif
			...
			namespace G {
				...
				template <typename T> class unique_ptr
				{
					public:
						...
						operator bool () const { return m_p != nullptr; }
						unique_ptr( const unique_ptr<T> & rhs ) { m_p = rhs.m_p ; const_cast<unique_ptr<T>&>(rhs).m_p = 0 ; } // auto_ptr semantics
					private:
	 ...
	 */
		...
		#include <grp.h>
			...
			inline errno_t strncpy_s( char * dst , size_t n , const char * src , size_t c )
			{
				...
				size_t d = strlen(src) ; if( c != _TRUNCATE && c < d ) d = c ;
				if( d >= n )
				{
					if( c != _TRUNCATE ) { *dst = '\0' ; return ERANGE ; }
					strncpy( dst , src , n ) ;
					dst[n-1U] = '\0' ;
				}
				else
