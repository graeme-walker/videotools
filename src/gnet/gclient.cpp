...
GNet::Client::Client( const Location & remote_info , unsigned int connection_timeout ,
	...
	bool sync_dns ) :
		...
		m_connection_timer(*this,&Client::onConnectionTimeout,*static_cast<EventHandler*>(this)) ,
		m_response_timer(*this,&Client::onResponseTimeout,*static_cast<EventHandler*>(this)) ,
		m_line_buffer(eol)
{
